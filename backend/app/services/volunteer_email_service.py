...
def send_volunteer_email(
    ...
    applicant_msg["Subject"] = f"Thank You for Volunteering with Us - [{reference}]"
    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;border:1px solid #e9e9e9;padding:30px;">
      ...
      <div style="background:#f8fafc;border-radius:7px;padding:20px;margin:20px 0;border:1px solid #e3e7ee;">
        ...
        <table style="width:100%;margin-top:12px;font-size:14px;">
          ...
          {f'<tr><td style="padding:6px 0;color:#666;vertical-align:top;">Attachments:</td><td style="padding:6px 0;">{attachments_html}</td></tr>' if attachments_html else ''}
        </table>
      </div>
      ...
      <p style="color:#888;font-size:13px;">Questions? Email us at volunteer@hecares.org</p>
    </div>
    """
...
Questions? Email us at volunteer@hecares.org
"""
    ...
    admin_msg["Subject"] = f"New Volunteer Application - {name} [{reference}]"
    ...
    <div style="font-family:Arial,sans-serif;max-width:700px;margin:auto;padding:20px;">
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px;margin-top:20px;">
        ...
        <tr style="background:#f8fafc;">
          ...
          <td style="padding:10px;border:1px solid #e5e7eb;">{contact}</td>
        </tr>
        <tr>
    ...
    admin_msg.set_content(f"New volunteer application from {name} - Reference: {reference}")
